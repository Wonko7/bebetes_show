...
*/
 ...
 gtk_plot_canvas_put_child(GTK_PLOT_CANVAS(canvas), child, .15, .06, .8, .70);

 gtk_plot_canvas_set_magnification(GTK_PLOT_CANVAS(canvas), 0.7);
 ...
 gtk_plot_canvas_export_ps(GTK_PLOT_CANVAS(canvas), "demoimage.ps", 0, 0, 
                           GTK_PLOT_LETTER);
